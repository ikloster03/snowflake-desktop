...
- **Ограничения производительности**
  - Замедление работы при проектах с более чем 100 персонажами
  - Снижение отзывчивости интерфейса при работе с текстами объемом более 50,000 слов
  - Ограничение на количество одновременно отображаемых элементов в Timeline (до 200)
- **Функциональные ограничения**
  - Отсутствие полноценной системы совместной работы
  - Ограниченные возможности форматирования текста в редакторе
  - Отсутствие встроенной системы проверки орфографии и грамматики
  - Ограниченная поддержка медиафайлов (только изображения в форматах JPG, PNG)
- **Ограничения интерфейса**
  - Невозможность одновременного просмотра нескольких сцен/глав
  - Ограниченная настройка внешнего вида интерфейса
  - Отсутствие мобильной версии приложения

## Статус разработки компонентов

### Project Module (Управление проектами)
...
- **Завершенные компоненты:**
  ...
  - Базовый экспорт проекта
- **В разработке:**
  - Улучшенная система резервного копирования
  - Расширенные опции экспорта
  - Шаблоны для новых проектов

### Book Module (Управление книгами)

- **Статус: 90% готовности**
- **Завершенные компоненты:**
  - Управление книгами и их метаданными
  - Управление сериями и связями между книгами
  - Управление авторами
  - Аннотации и синопсисы
- **В разработке:**
  - Расширенная система метаданных
  - Улучшенное управление обложками книг
  - Продвинутая система связей между книгами

### Projection Module (Проекции)

- **Статус: 75% готовности**
- **Завершенные компоненты:**
  - Управление главами и сценами
  - Базовая временная шкала
  - Управление статусами сцен
- **В разработке:**
  - Улучшенная визуализация временной шкалы
  - Продвинутые инструменты планирования сюжета
...
- **Завершенные компоненты:**
  - Управление персонажами
  - Управление локациями
  - Базовая карта связей персонажей
- **В разработке:**
  - Улучшенная карта мира
  - Расширенная система атрибутов персонажей
  - Управление предметами и артефактами
  - Система событий и их взаимосвязей

### Export Module (Экспорт)

- **Статус: 60% готовности**
- **Завершенные компоненты:**
  - Базовый экспорт в DOCX
  - Экспорт и импорт проектов в формате .snflk
- **В разработке:**
  - Экспорт в PDF с продвинутым форматированием
  - Экспорт материалов лора в HTML
  - Настраиваемые шаблоны для экспорта
  - Экспорт карты персонажей и временной шкалы в графические форматы
