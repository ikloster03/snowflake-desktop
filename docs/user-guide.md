...
2. Нажмите "Добавить главу" для создания новой главы
3. Для каждой главы можно добавить сцены, нажав "Добавить сцену"
4. Для каждой сцены укажите:
   - Название
   - Описание
   - Участвующие персонажи
   - Локацию
5. Используйте drag-and-drop для изменения порядка глав и сцен
