export const bookI18n = {
  'en-US': {
    ...
    book: {
      ...
      writeHere: 'Write your chapter here...',
      errors: {
        notFound: 'Book not found',
        noCurrentBook: 'No current book selected. Please select a book first.',
      },
      empty: {
        ...
        chapters: 'No chapters added yet',
        stages: 'No scenes added yet',
      },
      deletion: {
        title: 'Delete Book',
  ...
  'ru-RU': {
    ...
    book: {
      ...
      chapters: 'Главы',
      stages: 'Сцены',
      selectChapter: 'Выберите главу для начала редактирования',
      writeHere: 'Пишите вашу главу здесь...',
      errors: {
        notFound: 'Книга не найдена',
        noCurrentBook: 'Текущая книга не выбрана. Пожалуйста, сначала выберите книгу.',
      },
      empty: {
        books: 'Книги еще не добавлены',
        series: 'Серии еще не добавлены',
        authors: 'Авторы еще не добавлены',
        description: 'Описание отсутствует',
        genres: 'Жанры не выбраны',
        chapters: 'Главы еще не добавлены',
        stages: 'Сцены еще не добавлены',
      },
      deletion: {
        title: 'Удалить книгу',
